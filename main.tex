...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=70mm]{QDSOA_Based_XOR.eps}
...
\begin{center}
  \includegraphics[width=70mm]{QDSOA_Based_XOR.eps}
  \caption{Eyediagram of output result}
  \label{fig:eye_dia}
\end{center}
\end{figure}
...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=70mm]{Encoder.eps}
...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=70mm]{send_compare.eps}
...
\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=70mm]{passive_compare.eps}
