...
The operation of the PC-QDSOAs can be theoretically studied by means of a rate equation model{\cite{pcqdsoa}}. InAs QDs consists of a ground state (GS), an excited state (ES), and an upper state (US). An quantum well (QW) is common carrier reservoir where current injection  Moreover, because the size and shape of QDs. Thus, a rate equation of the PC-QDSOA is as follows:
