...
The operation of the PC-QDSOAs can be theoretically studied by means of a rate equation model{\cite{pcqdsoa}}. InAs QDs consists of a ground state (GS), an excited state (ES), and an upper state (US). Thus, a rate equation of the PC-QDSOA is as follows:
