...
The PC-QDSOAs used in this study are composed of GaAs, doped GaAs, ${\rm{In_{0.15}Ga_{0.85}As}}$ and InAs as an active region to enhance optical power around ${\rm{1.3\mu m}}$. The population inversion in the active regions of amplifiers is achieved by passing current through laterally doped ${\rm{p^{+}-p-n^{+}}}$ structures. Also, the waveguide of PC-QDSOA is W1 PCW wherein slow light can be achieved with either zero group velocity dispersion and zero third order dispersion. This waveguide can be archived by proper shifting and narrowing of the first two rows of air holes adjacent to the waveguide core. The operation of the PC-QDSOA can be numerically analyzed by means of a rate equation model and wave propagation equation{\cite{pcqdsoa}}. Physical parameters and these equations related to numerical analysis can be found in {\cite{pcqdsoa}}. The schematic diagram of PC-QDSOA is illustrated in Fig.{\ref{fig:pcqdsoa}}. 
