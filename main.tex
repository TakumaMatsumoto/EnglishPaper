...
Ultrafast and large capacity data transmission is required to cope with expanding network traffic data. In current optical network system, digital signals are coverted to optical signals optical signals go through optical fiber 
